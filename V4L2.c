...
int setV4l2DeviceParam(void* v4l2ctx, int *width, int *height)
{
	...
	format.fmt.pix.field = V4L2_FIELD_INTERLACED;	//修改了由V4L2_FIELD_NON→V4L2_FIELD_INTERLACED！！！
...
int V4l2StopMapBuffer(void* v4l2ctx)
{
	...
	int count;
	V4L2_CONTEXT* V4l2_Context = (V4L2_CONTEXT*) v4l2ctx;
	for(count = 0; count < V4l2_Context->mCamFd; count++)
	{
...
int GetFrame(void* v4l2ctx, struct v4l2_buffer *buff)
{
	int ret = -1;
	V4L2_CONTEXT* V4l2_Context = (V4L2_CONTEXT*) v4l2ctx;
	buff->field = V4L2_FIELD_INTERLACED;//filed参数修改V4L2_FIELD_NON→V4L2_FIELD_INTERLACED
	buff->memory = V4L2_MEMORY_MMAP;
	buff->type = V4L2_BUF_TYPE_VIDEO_CAPTURE;
